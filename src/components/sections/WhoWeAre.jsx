...
export default function WhoWeAre() {
  return (
    <div>
      <section className="bg-white rounded-t-lg p-6 grid gap-4">
      ...
      <img className="rounded-b-lg" src="/src/assets/images/foto_bilinguismo.jpeg" alt="billingual teacher with students" />
    </div>
  );
}
